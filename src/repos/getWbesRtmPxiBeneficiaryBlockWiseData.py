...
def getWbesRtmPxiBeneficiaryBlockWiseData(appDbConnStr: str, startDt: dt.datetime, endDt: dt.datetime,beneficiary:str,beneficiary_type:str) -> List[IWbesMetricsDataRecord]:
    targetColumns = ['TIME_STAMP', 'BENEFICIARY' ,'DATA_VALUE', 'BENEFICIARY_TYPE']

    metricsFetchSql = """
            select {0} from 
            mo_warehouse.WBES_RTM_PXI sf
